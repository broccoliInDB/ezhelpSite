...
title: Markdown
linktitle: Markdown
description: Markdown 사용법을 제공합니다.
weight: 704
disableToc: false
draft: false
date: 2019-10-18T17:14:23+09:00
tags: [markdown]
---
## Overview
---
...
- 기본 마크다운 문법은 일반적인 방식과 동일합니다. 

- 현 사이트에서 적용되는 markdown 문법이 몇가지 있는데 사항은 아래와 같습니다.  

  - [highlight 적용](/documents/markdown/#syntax-highlighting) : 핸들바를 적용해 javascript, handlebars를 code를 표현할 때
  - [image size 조절](/documents/markdown/#resizing-image)

  <i class="fas fa-info-circle"></i> code를 표현할 때는 기본 markdown인 문법인 \`\`\` 를 사용하는 방법도 있지만 highlight를 적절히 사용하여 위에 방식을 사용하는것을 권장한다.  
...
```
{{</* highlight javascript "linenos=inline,hl_lines=4-7 11,linenostart=199" */>}}
grunt.initConfig({
  assemble: {
    options: {
      assets: 'docs/assets',
